...
export const sendPasswordResetEmail = async (
  ...
  const subject = "Reset Your DSR Password";
  const resetLink = `${
    process.env.NEXTAUTH_URL || "http://localhost:3000"
  }/reset-password?token=${userData.resetToken}`;
  ...
  const htmlContent = `
    ...
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Reset Your DSR Password</title>
        <style>
            body {
                font-family: Arial, sans-serif;
                line-height: 1.6;
    ...
    <body>
        ...
        <div class="content">
            ...
            <p>A password reset has been requested for your DSR system account.</p>
            
            <div class="info-box">
                <strong>📧 Account:</strong> ${userEmail}<br>
                <strong>🔐 Action:</strong> Password Reset
            </div>
            
            <p>If you did not request this password reset, you can safely ignore this email.</p>
            
            <p>To set your new password, click the button below:</p>
            <a href="${resetLink}" class="button" style="display: inline-block; background-color: #2563eb !important; color: #ffffff !important; padding: 12px 24px; text-decoration: none; border-radius: 6px; margin: 20px 0; font-weight: bold; border: none; font-size: 16px;">Reset Password</a>
            
            <p>Or copy and paste this link into your browser:<br>
            <a href="${resetLink}">${resetLink}</a></p>
            
            <div class="warning">
                <strong>⏰ Important:</strong> This reset link will expire in 24 hours for security reasons. Please complete your password reset soon.
            </div>
  ...
  const textContent = `
    Password Reset Request - DSR System
    
    Hello ${userName}!
    
    A password reset has been requested for your DSR system account.
